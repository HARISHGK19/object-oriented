...
public class cashier {
   ...
   * @param newVar the new value of product_name
   */
  public void setProduct_name (void newVar) {
    product_name = newVar;
  }
   ...
   * @param newVar the new value of cost_of_product
   */
  public void setCost_of_product (void newVar) {
    cost_of_product = newVar;
  }
   ...
   */
  public void getCost_of_product () {
